# Powerline colorscheme for xsolarized-dark Kakoune theme



plug "andreyorst/powerline.kak" defer powerline %{
    set-option global powerline_ignore_warnings true
    set-option global powerline_format 'git bufname line-column langmap smarttab mode_info filetype client session position'
    set-option global powerline_separator '║'
    set-option global powerline_separator_thin ''
} defer powerline_bufname %{
    set-option global powerline_shorten_bufname 'short'
} defer powerline_xsolarized_dark %{
    powerline-theme xsolarized-dark
} config %{
    powerline-start
}


hook global ModuleLoaded powerline %{ require-module powerline_xsolarized_dark }

provide-module powerline_xsolarized_dark %§
set-option -add global powerline_themes "xsolarized-dark"

define-command -hidden powerline-theme-xsolarized-dark %{ evaluate-commands %sh{
    base03='rgb:002b36'
    base02='rgb:073642'
    base01='rgb:586e75'
    base00='rgb:657b83'
    ...
    printf "%s\n" "
        ...
        declare-option -hidden str powerline_color01 ${base1} # bg: position
        ...
        declare-option -hidden str powerline_color07 ${base01}  # fg: mode-info
        declare-option -hidden str powerline_color08 ${base02} # base background
        declare-option -hidden str powerline_color09 ${base1} # bg: line-column
